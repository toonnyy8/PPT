...
const template = (() => {
     ...
     */
    const div_hc = (paddingNum) =>
        html.div({
            class: ["text-xl"],
            style: [css.p.t(paddingNum), css.tx.center(), css.w.percent(100)],
        })
    ...
    return {
         ...
         */
        default_page: (title, content) => {
            return html.page()([
                div_vc([
                    div_hc(10)([
                        span3xl([title]),
                        html.hr(),
                        html.div({ style: [css.h.mm(150), css.tx.justify(), css.m.x(20)] })([content]),
                    ]),
                ]),
            ])
        },
        ...
        page2: (contentMargin) =>
            ...
            (title1, title2, content) => {
                return html.page()([
                    div_vc([
                        div_hc(10)([
                            html.p({ style: [css.tx.left(), css.pos.abs()] })([spanbase([title1])]),
                            span3xl([title2]),
                            html.hr(),
                            html.div({
                                style: [css.h.mm(150), css.tx.justify(), css.m.x(contentMargin)],
        ...
        page3: (contentMargin) =>
            ...
            (title1, title2, title3, content) => {
                return html.page()([
                    div_vc([
                        div_hc(10)([
                            html.p({ style: [css.tx.left(), css.pos.abs(), css.w.mm(277)] })([spanbase([title1])]),
                            html.p({ style: [css.tx.right(), css.pos.abs(), css.w.mm(277)] })([spanlg([title2])]),
                            span3xl([title3]),
                            html.hr(),
                            html.div({
                                style: [css.h.mm(150), css.tx.justify(), css.m.x(contentMargin)],
